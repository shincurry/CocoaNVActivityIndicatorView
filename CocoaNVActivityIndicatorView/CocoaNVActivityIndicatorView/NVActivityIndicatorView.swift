...
public class NVActivityIndicatorView: NSView {
    ...
    @IBInspectable public var color: NSColor = NVActivityIndicatorView.DEFAULT_COLOR
...
//        BackgroundColor = NSColor.clear
     ...
     */
    public init(frame: CGRect, type: NVActivityIndicatorType? = nil, color: NSColor? = nil, padding: CGFloat? = nil) {
